org 0, numlab 140, numio 13, numdata 116, numcomm 48, numcommline 36
...
DRAW_RING_LEFT_CORNER EQU $057a
...
DRAW_UPPER_SCREEN_FOR_A_FIGHT EQU $2ee5
...
050f: CD 0D 2E       CALL  $2E0D
0512: CD 44 2E       CALL  $2E44
...
0542: CD E5 2E       CALL  DRAW_UPPER_SCREEN_FOR_A_FIGHT
0545: CD 7B 2F       CALL  $2F7B
...
0558: CD 0B 2F       CALL  $2F0B
055b: CD 3A 2D       CALL  $2D3A
055e: D7             RST   $10

055f: CD A8 2E       CALL  $2EA8
0562: CD 6D 30       CALL  $306D
0565: 3E FE          LD    A,#$FE
0567: 32 CD D7       LD    ($D7CD),A
056a: CD 3A 2D       CALL  $2D3A
056d: CD F0 12       CALL  $12F0
0570: CD 44 13       CALL  $1344
0573: D7             RST   $10

0574: CD C4 2D       CALL  $2DC4
0577: CD A8 2E       CALL  $2EA8
DRAW_RING_LEFT_CORNER:
057a: CD A4 30       CALL  $30A4
...
0765: CD E5 2E       CALL  DRAW_UPPER_SCREEN_FOR_A_FIGHT
...
079d: CD A8 2E       CALL  $2EA8
07a0: CD E6 2F       CALL  $2FE6
07a3: 3E FE          LD    A,#$FE
07a5: 32 CD D7       LD    ($D7CD),A
07a8: CD 0B 2F       CALL  $2F0B
...
0838: CD A8 2E       CALL  $2EA8
083b: CD A4 30       CALL  $30A4
083e: F1             POP   AF
...
0902: CD 7B 2F       CALL  $2F7B
0905: CD A8 2E       CALL  $2EA8
...
3d42: CE F3 08 20 34 E3 DF 15 18 1B 1D 17 18 0C FF 22 
3d52: 0B FF 1C 15 0A 12 DB 1D 12 17 12 FF 1D 0C 0E 15 
3d62: 0E 1C E3 00 00 E2 DF 29 FF 1D 17 12 1B 19 FF 18 
3d72: 1D FF 17 18 1D 1D DC 1E 0B FF 1C 1C 0E 1B 19 FF 
3d82: 0D 17 0A E3 00 00 00 00 00 20 2C E7 D5 28 FF 28 
3d92: FF 28 20 30 DD FF 25 FF 22 1B 1D 17 0E FF 0E 16 
3da2: 0A 17 E7 00 

Error: missed a data line, count-1=3da6,curdata=11,numdata=116,start=3D49, end=3D63
Error: missed a data line, count-1=3da6,curdata=12,numdata=116,start=3D69, end=3D80
Error: missed a data line, count-1=3da6,curdata=13,numdata=116,start=3D98, end=3DA3
