...
MCP_MAX_DISKS_AT_A_TIME EQU $c41e
...
0d34: 32 1E C4       LD    (MCP_MAX_DISKS_AT_A_TIME),A
0d37: C9             RET   
...
0ea0: 32 1E C4       LD    (MCP_MAX_DISKS_AT_A_TIME),A
...
START_GAME:
1f97: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
...
20a2: 3C             INC   A
20a3: 32 1E C4       LD    (MCP_MAX_DISKS_AT_A_TIME),A
20a6: C9             RET   
...
302d: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
...
34b4: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
34b7: 47             LD    B,A
...
3a2b: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
3a2e: 4F             LD    C,A
3a2f: 06 00          LD    B,#$00
...
456d: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
4570: 47             LD    B,A
...
4838: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
483b: 47             LD    B,A
...
4a1a: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
4a1d: 47             LD    B,A
...
6375: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
...
6827: 3A 1E C4       LD    A,(MCP_MAX_DISKS_AT_A_TIME)
682a: 47             LD    B,A
