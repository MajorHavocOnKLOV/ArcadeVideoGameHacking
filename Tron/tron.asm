...
PRINT_HIGH_SCORE_SCREEN EQU $1558
RANKINGS_S EQU $1653
...
TRIGGER___FIRES_DISK_S3 EQU $19a3
...
KNOB______NOT_USED_S2 EQU $1ad7
...
KNOB______AIMS_DISK_S2 EQU $1c08
...
JOYSTICK__MOVES_TRON_S2 EQU $1d26
TRIGGER___FIRES_DISK_S2 EQU $1d3b
KNOB______AIMS_DISK_S3 EQU $1d50
...
SET_SOME_VALUES_IN_C02X? EQU $621d
...
COIN_CHUTE_1_S2 EQU $a8cb
COINS_FOR_S EQU $a8d8
CREDITS_S2 EQU $a8e2
COIN_CHUTE_2_S2 EQU $a8ea
...
REMAINING_DISKS/SHOTS_AT_A_TIME EQU $c41d
MAX_DISKS/SHOTS_AT_A_TIME EQU $c41e
...
00b9: 50             LD    D,B
00ba: CC 1D 62       CALL  Z,SET_SOME_VALUES_IN_C02X?
00bd: 3C             INC   A
00be: C6 E8          ADD   A,#$E8
00c0: 76             HALT  
...
0e55: 01 C0 00 38 00 07 01 C7 01 F8 
...
0f53: 11 14 B1       LD    DE,PLAYER_1_S2
...
16c5: FC F6 16       CALL  M,GRID_BUGS___50_S
16c8: 78             LD    A,B
16c9: 48             LD    C,B
16ca: 2F             CPL   
16cb: 00             NOP   
...
1788: 00 01 88 FD BA 17 8E FE 50 18 92 FE 69 18 96 FE 
1798: 84 18 9A FE 9C 18 9E FE B5 18 A4 FE C4 18 A8 FE 
17a8: DF 18 AC FE F8 18 B0 FE 12 19 B4 FE 2C 19 00 00 
17b8: 00 01 
...
1a79: AE FE 2B 1B B2 FE 42 1B B6 FE 5C 1B 00 00 00 01 
...
1cfe: 9C FE E3 1D A2 FE EC 1D A6 FE 06 1E 00 00 00 01 
...
JOYSTICK__MOVES_TRON_S2:
1d26: JOYSTICK  MOVES TRON

TRIGGER___FIRES_DISK_S2:
1d3b: TRIGGER   FIRES DISK

KNOB______AIMS_DISK_S3:
1d50: KNOB      AIMS DISK
...
START_GAME:
1f97: 3A 1E C4       LD    A,(MAX_DISKS/SHOTS_AT_A_TIME)
1f9a: 32 1D C4       LD    (REMAINING_DISKS/SHOTS_AT_A_TIME),A
...
*** pick game instructions to print
...
1ffe: 21 CA 2A       LD    HL,COLOR_PALETTE_1?
2001: CD 35 6F       CALL  COPY_20_FROM_HL_TO_FF80
2004: 21 CA 2A       LD    HL,COLOR_PALETTE_1?
...
*** This increment gives the next game an extra disk/shot! Is it a feature or a bug
20a3: 32 1E C4       LD    (MAX_DISKS/SHOTS_AT_A_TIME),A
20a6: C9             RET   
...
2e99: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
2e9c: 7E             LD    A,(HL)
2e9d: B7             OR    A,A
2e9e: C8             RET   Z
...
2f3f: 3A 1D C4       LD    A,(REMAINING_DISKS/SHOTS_AT_A_TIME)
2f42: B7             OR    A,A
...
3186: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
3189: 34             INC   (HL)
318a: C9             RET   
...
*** Set up shots (up to 4) in sprites 3-6 (F00C-F01B)
...
475a: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
475d: 34             INC   (HL)
...
482e: 3A 1D C4       LD    A,(REMAINING_DISKS/SHOTS_AT_A_TIME)
4831: B7             OR    A,A
4832: C8             RET   Z
...
487b: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
487e: 35             DEC   (HL)
487f: C9             RET   
...
5c12: 04 04 03 00 63 05 02 63 00 01 00 00 00 00 00 
...
5d46: CD 1D 62       CALL  SET_SOME_VALUES_IN_C02X?
5d49: 3E 01          LD    A,#$01
...
5e50: CD 1D 62       CALL  SET_SOME_VALUES_IN_C02X?
...
5fe3: 3A 26 C0       LD    A,(IO_TRON_X)
5fe6: FE 80          CP    A,#$80
5fe8: 3E 4B          LD    A,#$4B
5fea: 38 02          JR    C,$5FEE

5fec: 3E B6          LD    A,#$B6
5fee: 32 26 C0       LD    (IO_TRON_X),A
...
6104: 3A 1D C4       LD    A,(REMAINING_DISKS/SHOTS_AT_A_TIME)
6107: B7             OR    A,A
...
6163: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
6166: 7E             LD    A,(HL)
6167: B7             OR    A,A
6168: C8             RET   Z
...
SET_SOME_VALUES_IN_C02X?:
621d: 3E 80          LD    A,#$80
621f: 32 26 C0       LD    (IO_TRON_X),A
6222: 3E D4          LD    A,#$D4
...
6371: FD 21 18 F0    LD    IY,DISK_1_TO_3/MAYBE_SHOTS_TOO?
6375: 3A 1E C4       LD    A,(MAX_DISKS/SHOTS_AT_A_TIME)
...
6437: FD 21 18 F0    LD    IY,DISK_1_TO_3/MAYBE_SHOTS_TOO?
...
64e3: 21 1D C4       LD    HL,REMAINING_DISKS/SHOTS_AT_A_TIME
64e6: 34             INC   (HL)
64e7: C9             RET   
...
6827: 3A 1E C4       LD    A,(MAX_DISKS/SHOTS_AT_A_TIME)
682a: 47             LD    B,A
682b: FD 21 E8 C1    LD    IY,$C1E8
682f: 21 18 F0       LD    HL,DISK_1_TO_3/MAYBE_SHOTS_TOO?
...
7165: C5             PUSH  BC             ;to get the code at 9900 to disassemble correctly
7166: 47             LD    B,A
...
aa8a: 01 CE AA       LD    BC,HIT_FIRE_BUTTON_S2
