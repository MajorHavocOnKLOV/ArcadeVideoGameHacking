...
DATA_TIMES_TO_COMPARE_FOR THE_TIME_REPORT EQU $132d
...
IO_TRON_X/MCP_DISK_3_DATA EQU $c026
IO_TRON_Y EQU $c028
...
12a1: DD 21 2D 13    LD    IX,DATA_TIMES_TO_COMPARE_FOR THE_TIME_REPORT
12a5: 06 09          LD    B,#$09
...
DATA_TIMES_TO_COMPARE_FOR THE_TIME_REPORT:
132d: 00 30 
132f: 01 00 
1331: 01 30 
1333: 02 00 
...
45e6: CD 52 47       CALL  TANK_PROCESS_HIT?
45e9: 05             DEC   B
...
5fe3: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
5fe6: FE 80          CP    A,#$80
5fe8: 3E 4B          LD    A,#$4B
5fea: 38 02          JR    C,$5FEE

5fec: 3E B6          LD    A,#$B6
5fee: 32 26 C0       LD    (IO_TRON_X/MCP_DISK_3_DATA),A
...
602b: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
602e: FE 4C          CP    A,#$4C
...
6069: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
...
621d: 3E 80          LD    A,#$80
621f: 32 26 C0       LD    (IO_TRON_X/MCP_DISK_3_DATA),A
6222: 3E D4          LD    A,#$D4
...
623d: 0E 02          LD    C,#$02
623f: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
6242: FE 80          CP    A,#$80
...
624b: 3D             DEC   A
624c: 32 26 C0       LD    (IO_TRON_X/MCP_DISK_3_DATA),A
624f: 18 01          JR    $6252
...
6290: 3E 00          LD    A,#$00
6292: 32 26 C0       LD    (IO_TRON_X/MCP_DISK_3_DATA),A
6295: 18 07          JR    $629E
...
62ad: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
...
6468: 3E FF          LD    A,#$FF
646a: 21 26 C0       LD    HL,IO_TRON_X/MCP_DISK_3_DATA
646d: 86             ADD   A,(HL)
...
64a6: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
...
6632: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
6635: 92             SUB   A,D
...
6889: 3A 26 C0       LD    A,(IO_TRON_X/MCP_DISK_3_DATA)
...
*** ?, ?, number of grid bugs, ?
*** C006 is set to 2nd number - 3rd number.  Why?
...
*** ?, X, ?, Y, ?, ?, ?, ?, 3rd number per grid bug, ?, 0x80
