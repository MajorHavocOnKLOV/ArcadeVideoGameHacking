...
TANK_CHECK_FOR_BULLET_HIT_ON_ENEMY EQU $46f5
TANK_CHECK_FOR_BULLET_HIT_ON_USER EQU $472b
...
TANK_INITIALIZE_BULLET EQU $4aff
TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM EQU $4b70
...
3b94: E5             PUSH  HL
3b95: CD 70 4B       CALL  TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM
3b98: E1             POP   HL
3b99: 7D             LD    A,L
3b9a: C6 04          ADD   A,#$04
...
3bbf: 23             INC   HL
3bc0: 36 0E          LD    (HL),#$0E
3bc2: CD A5 40       CALL  TANK_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANK_XY
...
3d13: 23             INC   HL
3d14: 36 0E          LD    (HL),#$0E
3d16: CD A5 40       CALL  TANK_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANK_XY
...
3eb6: C6 08          ADD   A,#$08
3eb8: 4F             LD    C,A
3eb9: CD A5 40       CALL  TANK_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANK_XY
...
424f: 4F             LD    C,A
4250: DD E5          PUSH  IX
4252: CD A5 40       CALL  TANK_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANK_XY
4255: DD E1          POP   IX
...
4619: 8E             ADC   A,(HL)
461a: 4F             LD    C,A
461b: CD F5 46       CALL  TANK_CHECK_FOR_BULLET_HIT_ON_ENEMY
461e: 30 05          JR    NC,$4625

4620: FD 36 0A 01    LD    (IY+$0A),#$01
4624: C9             RET   

4625: CD 2B 47       CALL  TANK_CHECK_FOR_BULLET_HIT_ON_USER
...
TANK_CHECK_FOR_BULLET_HIT_ON_USER:
...
4a95: BE             CP    A,(HL)
4a96: DC FF 4A       CALL  C,TANK_INITIALIZE_BULLET
4a99: 18 59          JR    $4AF4
...
4aab: 2B             DEC   HL
4aac: BE             CP    A,(HL)
4aad: D4 FF 4A       CALL  NC,TANK_INITIALIZE_BULLET
4ab0: 18 42          JR    $4AF4
...
4ac1: 3A 02 C0       LD    A,(TANK_Y_OR_GS_DISK_Y_OR_SOLAR_SAILER_X_Y)
...
4ad9: BE             CP    A,(HL)
4ada: DC FF 4A       CALL  C,TANK_INITIALIZE_BULLET
4add: 18 15          JR    $4AF4
...
4aef: 2B             DEC   HL
4af0: BE             CP    A,(HL)
4af1: D4 FF 4A       CALL  NC,TANK_INITIALIZE_BULLET
4af4: 0D             DEC   C
...
4b6c: CD 70 4B       CALL  TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM
4b6f: C9             RET   

TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM:
...
4ba3: 06 05          LD    B,#$05
4ba5: CD 70 4B       CALL  TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM
...
4bc8: 4F             LD    C,A
4bc9: E5             PUSH  HL
4bca: CD F5 46       CALL  TANK_CHECK_FOR_BULLET_HIT_ON_ENEMY
...
4bdc: CD 2B 47       CALL  TANK_CHECK_FOR_BULLET_HIT_ON_USER
...
4c05: CD 70 4B       CALL  TANK_BULLET_UPDATE_SPRITE_FROM_IY_RAM
4c08: C9             RET   
