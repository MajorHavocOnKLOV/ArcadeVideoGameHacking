org 0, numlab 800, numio 12, numdata 1574, numcomm 293, numcommline 472
...
GET_INITIALS_FOR_A_HIGH_SCORE EQU $0f7f
...
CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S EQU $c416
...
030a: 21 6F C4       LD    HL,LEFT_1_COIN_INPUT?
030d: 34             INC   (HL)
...
0340: 3A 6F C4       LD    A,(LEFT_1_COIN_INPUT?)
0343: 3D             DEC   A
0344: F8             RET   M

0345: 32 6F C4       LD    (LEFT_1_COIN_INPUT?),A
0348: 3E 20          LD    A,#$20
...
038b: 21 6F C4       LD    HL,LEFT_1_COIN_INPUT?
038e: 34             INC   (HL)
...
0f74: FE 0B          CP    A,#$0B
0f76: DC 7F 0F       CALL  C,GET_INITIALS_FOR_A_HIGH_SCORE
0f79: CD 3F 13       CALL  $133F
0f7c: C3 9E 12       JP    $129E

GET_INITIALS_FOR_A_HIGH_SCORE:
0f7f: AF             XOR   A,A
...
1107: 11 16 C4       LD    DE,CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S
110a: 06 03          LD    B,#$03
110c: 7E             LD    A,(HL)
110d: CB 27          SLA   A
110f: CB 27          SLA   A
...
117a: 21 16 C4       LD    HL,CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S
117d: 06 03          LD    B,#$03
117f: DD E5          PUSH  IX
1181: 7E             LD    A,(HL)
...
11cb: 21 16 C4       LD    HL,CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S
11ce: 06 03          LD    B,#$03
11d0: 7E             LD    A,(HL)
...
1346: 06 09          LD    B,#$09
1348: 3A 16 C4       LD    A,(CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S)
...
13a1: 3A 16 C4       LD    A,(CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S)
13a4: BE             CP    A,(HL)
...
13b9: 3A 16 C4       LD    A,(CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S)
...
13cf: 3A 16 C4       LD    A,(CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S)
13d2: BE             CP    A,(HL)
...
13e4: 3A 16 C4       LD    A,(CREDITS_TO_START_A_GAME_NULL_TERMINATED_ASCII_1_OF_3_S)
