org 0, numlab 721, numio 12, numdata 1532, numcomm 226, numcommline 402
...
TANK_POSITION_HIT_ON_ENEMY_TANK? EQU $4531
TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11 EQU $455a
TANKS_PROCESS_DISKS_THROWN? EQU $456d
DATA_USED_FOR_???_TO_45FE EQU $45ed
TANK_PROCESS_DISKS_THROWN EQU $45ff
TANKS_PROCESS_ENEMY_BULLETS EQU $46f5
...
0fd4: 3E 02          LD    A,#$02
0fd6: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
...
125b: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
...
2118: 11 04 C0       LD    DE,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
...
2135: 4F             LD    C,A
2136: 87             ADD   A,A
2137: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
...
2e09: 2A 06 C0       LD    HL,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
2e0c: ED 5B 0A C0    LD    DE,($C00A)
2e10: 19             ADD   HL,DE
2e11: 22 06 C0       LD    (GRID_BUGS_NUMBER_OF_UNUSED_SLOTS),HL
2e14: 7C             LD    A,H
2e15: FE 21          CP    A,#$21
...
2e7e: E6 10          AND   A,#$10
2e80: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
2e83: BE             CP    A,(HL)
2e84: C8             RET   Z
...
3e3f: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
3e42: CB 2F          SRA   A
3e44: 80             ADD   A,B
3e45: 47             LD    B,A
...
3e4c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
3e4f: CB 2F          SRA   A
3e51: 80             ADD   A,B
3e52: 47             LD    B,A
...
3e59: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
3e5c: CB 2F          SRA   A
3e5e: 81             ADD   A,C
3e5f: 4F             LD    C,A
...
3e66: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
3e69: CB 2F          SRA   A
3e6b: 81             ADD   A,C
3e6c: 4F             LD    C,A
...
3e72: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
3e75: CB 2F          SRA   A
3e77: 57             LD    D,A
3e78: 78             LD    A,B
3e79: 92             SUB   A,D
...
3e80: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
3e83: CB 2F          SRA   A
3e85: 57             LD    D,A
3e86: 78             LD    A,B
3e87: 92             SUB   A,D
...
3e8e: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
3e91: CB 2F          SRA   A
3e93: 57             LD    D,A
3e94: 79             LD    A,C
3e95: 92             SUB   A,D
...
3ea4: C6 08          ADD   A,#$08
3ea6: 47             LD    B,A
3ea7: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
3eaa: CB 2F          SRA   A
3eac: 57             LD    D,A
3ead: 79             LD    A,C
3eae: 92             SUB   A,D
...
3f65: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
3f68: 90             SUB   A,B
...
3f86: 21 06 C0       LD    HL,GRID_BUGS_NUMBER_OF_UNUSED_SLOTS
3f89: 90             SUB   A,B
...
4225: CD 5A 45       CALL  TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11
...
4274: CD 5A 45       CALL  TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11
4277: 06 03          LD    B,#$03
4279: 36 00          LD    (HL),#$00
427b: 23             INC   HL
427c: 36 3F          LD    (HL),#$3F
...
4369: CD 31 45       CALL  TANK_POSITION_HIT_ON_ENEMY_TANK?
...
4510: CD 5A 45       CALL  TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11
...
TANK_POSITION_HIT_ON_ENEMY_TANK?:
...
4539: CD 5A 45       CALL  TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11
...
*** Get pointer into data structure
TANK_DATA_ACCESS_HL_EQUALS_IX_PLUS_18_PLUS_4_TIMES_IX_PLUS_11:
...
*** X word, Y word, X delta word, Y delta word, (8 bytes)
*** ?, ?, ?, pointer to sprite for this disk, ?, ?, ?
...
4619: 8E             ADC   A,(HL)
461a: 4F             LD    C,A
461b: CD F5 46       CALL  TANKS_PROCESS_ENEMY_BULLETS
...
4736: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG
4739: 86             ADD   A,(HL)
473a: B8             CP    A,B
...
4747: 21 06 C0       LD    HL,GRID_BUGS_NUMBER_OF_UNUSED_SLOTS
474a: 86             ADD   A,(HL)
474b: B9             CP    A,C
...
*** Tanks: C111 is beginning of ?, size 0x9
...
4bc8: 4F             LD    C,A
4bc9: E5             PUSH  HL
4bca: CD F5 46       CALL  TANKS_PROCESS_ENEMY_BULLETS
...
5d7c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
5d7f: E6 06          AND   A,#$06
...
5dfe: 34             INC   (HL)
5dff: 21 06 C0       LD    HL,GRID_BUGS_NUMBER_OF_UNUSED_SLOTS
5e02: 34             INC   (HL)
5e03: CD 47 5F       CALL  $5F47
5e06: CD 6D 63       CALL  PROCESS_DISK_THROW?
5e09: CD 04 65       CALL  $6504
5e0c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
5e0f: B7             OR    A,A
...
5e25: 21 06 C0       LD    HL,GRID_BUGS_NUMBER_OF_UNUSED_SLOTS
5e28: BE             CP    A,(HL)
5e29: C0             RET   NZ
...
5f62: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
5f65: FE 01          CP    A,#$01
...
62e3: AF             XOR   A,A
62e4: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
...
62ff: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
...
634e: 3E 04          LD    A,#$04
6350: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A;Set flag to continue moving Solar Sailer but stop checking to drop Bit
6353: C9             RET   
...
6357: 3E 01          LD    A,#$01
6359: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
...
664d: 47             LD    B,A
664e: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
6651: B7             OR    A,A
...
6690: 3A 06 C0       LD    A,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
6693: 3D             DEC   A
6694: 32 06 C0       LD    (GRID_BUGS_NUMBER_OF_UNUSED_SLOTS),A
...
66da: 21 06 C0       LD    HL,GRID_BUGS_NUMBER_OF_UNUSED_SLOTS
66dd: 34             INC   (HL)
66de: C9             RET   
...
6791: 3E 02          LD    A,#$02
6793: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
...
67cc: 90             SUB   A,B
67cd: 32 06 C0       LD    (GRID_BUGS_NUMBER_OF_UNUSED_SLOTS),A
67d0: 23             INC   HL
67d1: 7E             LD    A,(HL)
...
991c: 2F             CPL   
991d: E6 10          AND   A,#$10
991f: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
...
998c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG)
998f: 47             LD    B,A
9990: DB 00          IN    A,(IO_0)
9992: 2F             CPL   
9993: E6 10          AND   A,#$10
9995: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG),A
9998: B7             OR    A,A
...
9b34: 22 06 C0       LD    (GRID_BUGS_NUMBER_OF_UNUSED_SLOTS),HL
9b37: 3E 18          LD    A,#$18
9b39: AF             XOR   A,A
...
9b76: 2A 06 C0       LD    HL,(GRID_BUGS_NUMBER_OF_UNUSED_SLOTS)
9b79: 16 00          LD    D,#$00
