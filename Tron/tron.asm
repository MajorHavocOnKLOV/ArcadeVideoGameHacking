...
org 0, numlab 829, numio 12, numdata 1587, numcomm 300, numcommline 492
...
TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY EQU $40a5
...
TANKS_PROCESS_DISKS_THROWN? EQU $456d
...
TANKS_CHECK_FOR_HIT_ON_ENEMY EQU $46f5
TANKS_CHECK_FOR_HIT_ON_USER EQU $472b
TANKS_TERMINATE_DISK_THROWN_AT_IY EQU $4752
...
TANKS_UPDATE_DISK_THROWN_SPRITE_FROM_RAM_AT_IY EQU $47c7
...
TANK_TERMINATE_BULLET_SET_X_OFF_SCREEN_AND_CALL_UPDATE_SPRITE EQU $4bfd
...
FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2 EQU $c407
...
0fc7: AF             XOR   A,A
0fc8: 32 07 C4       LD    (FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2),A
...
0ff8: 3A 07 C4       LD    A,(FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2)
0ffb: B7             OR    A,A
...
127c: 32 07 C4       LD    (FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2),A
127f: C9             RET   
...
*** Y, X, sprite, [additional sprites], 0 (end marker), destination vector, source vector
...
1fd1: AF             XOR   A,A
1fd2: 32 07 C4       LD    (FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2),A
...
3a52: E5             PUSH  HL
3a53: CD C7 47       CALL  TANKS_UPDATE_DISK_THROWN_SPRITE_FROM_RAM_AT_IY
3a56: E1             POP   HL
3a57: 3E 04          LD    A,#$04
...
3bbf: 23             INC   HL
3bc0: 36 0E          LD    (HL),#$0E
3bc2: CD A5 40       CALL  TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY
...
3be7: 3A 07 C4       LD    A,(FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2)
3bea: E6 02          AND   A,#$02
...
3c4b: CD 6D 45       CALL  TANKS_PROCESS_DISKS_THROWN?
...
3ca1: 3A 07 C4       LD    A,(FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2)
...
3cd4: 21 07 C4       LD    HL,FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2
3cd7: CB CE          SET   1,(HL)
...
3d13: 23             INC   HL
3d14: 36 0E          LD    (HL),#$0E
3d16: CD A5 40       CALL  TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY
...
3df4: CB 27          SLA   A
3df6: CB 27          SLA   A
3df8: 32 4D C1       LD    (TANKS_JOYSTICK_INPUT),A
...
3eb6: C6 08          ADD   A,#$08
3eb8: 4F             LD    C,A
3eb9: CD A5 40       CALL  TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY
...
*** 21 data blocks used by tanks, variable size so zero terminated
3f9a: 00 
...
*** 21x3 bytes: ?, vector to other data
4066: 18 9A 3F 
4069: 27 9B 3F 
406c: 30 A0 3F 
406f: 3F AD 3F 
...
409f: F7 62 40 
40a2: FF 65 40 
TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY:
...
424f: 4F             LD    C,A
4250: DD E5          PUSH  IX
4252: CD A5 40       CALL  TANKS_PUT_POINTERS_INTO_DATA_STRUCTURES_IN_HL_AND_BC_BASED_ON_ENEMY_TANKS_XY
4255: DD E1          POP   IX
...
428e: 21 07 C4       LD    HL,FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2
4291: CB C6          SET   0,(HL)
...
459c: 0E 05          LD    C,#$05
459e: CD C7 47       CALL  TANKS_UPDATE_DISK_THROWN_SPRITE_FROM_RAM_AT_IY
...
45e6: CD 52 47       CALL  TANKS_TERMINATE_DISK_THROWN_AT_IY
45e9: 05             DEC   B
...
4619: 8E             ADC   A,(HL)
461a: 4F             LD    C,A
461b: CD F5 46       CALL  TANKS_CHECK_FOR_HIT_ON_ENEMY
461e: 30 05          JR    NC,$4625

4620: FD 36 0A 01    LD    (IY+$0A),#$01
4624: C9             RET   

4625: CD 2B 47       CALL  TANKS_CHECK_FOR_HIT_ON_USER
...
SCORE_TANK_HIT_1:
47c2: 00 00 01 00 00 
TANKS_UPDATE_DISK_THROWN_SPRITE_FROM_RAM_AT_IY:
...
4bc8: 4F             LD    C,A
4bc9: E5             PUSH  HL
4bca: CD F5 46       CALL  TANKS_CHECK_FOR_HIT_ON_ENEMY
...
4bdc: CD 2B 47       CALL  TANKS_CHECK_FOR_HIT_ON_USER
...
4beb: CD FD 4B       CALL  TANK_TERMINATE_BULLET_SET_X_OFF_SCREEN_AND_CALL_UPDATE_SPRITE
4bee: E1             POP   HL
4bef: 23             INC   HL
4bf0: 7E             LD    A,(HL)
4bf1: FE FF          CP    A,#$FF
...
TANK_TERMINATE_BULLET_SET_X_OFF_SCREEN_AND_CALL_UPDATE_SPRITE:
...
51b9: 3A 07 C4       LD    A,(FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2)
...
54cc: 0E 27          LD    C,#$27
54ce: 06 80          LD    B,#$80
54d0: 32 07 C4       LD    (FLAG_ENTER_INITIALS_DONE_OR_LC_TRON_DIED_OR_TANKS_ENEMY_3RD_HIT_OR_VALUE_4_NEXT_SLOT_SCREEN_MESSAGE_Q2),A
54d3: 78             LD    A,B
