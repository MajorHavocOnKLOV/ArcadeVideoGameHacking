...
PRINT_OUT_LIVES_REMAINING_FOR_CURRENT_PLAYER EQU $06bb
...
SPRITE_TANK_3_HITS_AND_ENEMY_TANK EQU $f01c
...
*** 00 = 
*** 01 = DISPLAY_MCP_CONE_WITH_COPYRIGHTS_AND_NEXT_INSTRUCTIONS, DRAW_CREDITS_SCREEN, 
*** 02 = 
...
063e: CD BB 06       CALL  PRINT_OUT_LIVES_REMAINING_FOR_CURRENT_PLAYER
...
066c: C3 BB 06       JP    PRINT_OUT_LIVES_REMAINING_FOR_CURRENT_PLAYER
...
PRINT_OUT_LIVES_REMAINING_FOR_CURRENT_PLAYER:
06bb: B7             OR    A,A
06bc: C8             RET   Z
...
*** Red, Blue, Green, Yellow, Magenta, Cyan (and repeat)
MCP_BLOCKS_COLORS:
0e55: 01 C0 
0e57: 00 38 
0e59: 00 07 
...
INITIALIZE_LEVEL:
2115: 21 08 23       LD    HL,GS_VECTOR_TO_GAME_VECTORS
...
3a5f: 21 1C F0       LD    HL,SPRITE_TANK_3_HITS_AND_ENEMY_TANK
...
*** 8-F: ?, ?, ?, pointer to sprite for this disk, ?, ?, ?
...
4588: CB 27          SLA   A
458a: CB 27          SLA   A
458c: 21 1C F0       LD    HL,SPRITE_TANK_3_HITS_AND_ENEMY_TANK
458f: 85             ADD   A,L
...
46cb: E5             PUSH  HL
46cc: 21 1C F0       LD    HL,SPRITE_TANK_3_HITS_AND_ENEMY_TANK
...
Error: missed a comment line at A076, line=A078
Error: missed a comment line at A076, line=A078
