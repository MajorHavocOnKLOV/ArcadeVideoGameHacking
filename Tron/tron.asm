...
0a60: 3A F4 C4       LD    A,(LIVES_PER_PLAYER)
...
0cb5: 3A F4 C4       LD    A,(LIVES_PER_PLAYER)
...
106f: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
1072: 6F             LD    L,A
1073: 26 00          LD    H,#$00
1075: 29             ADD   HL,HL
1076: 19             ADD   HL,DE
...
109b: 09             ADD   HL,BC
109c: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
109f: C6 41          ADD   A,#$41
10a1: 77             LD    (HL),A
10a2: 23             INC   HL
10a3: 36 50          LD    (HL),#$50
10a5: 3A 14 C4       LD    A,($C414)
10a8: 32 03 C0       LD    (SOLAR_SAILER_Y),A
10ab: CB 27          SLA   A
10ad: CB 27          SLA   A
10af: CB 27          SLA   A
10b1: C6 10          ADD   A,#$10
...
2e88: 21 03 C0       LD    HL,SOLAR_SAILER_Y
2e8b: 7E             LD    A,(HL)
2e8c: B7             OR    A,A
...
2e94: 3E 04          LD    A,#$04
2e96: 32 03 C0       LD    (SOLAR_SAILER_Y),A
...
3e28: 47             LD    B,A
3e29: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
3e2c: 80             ADD   A,B
3e2d: 81             ADD   A,C
3e2e: 47             LD    B,A
...
3e9c: 78             LD    A,B
3e9d: 21 03 C0       LD    HL,SOLAR_SAILER_Y
3ea0: 96             SUB   A,(HL)
...
3f5a: 21 03 C0       LD    HL,SOLAR_SAILER_Y
3f5d: 86             ADD   A,(HL)
3f5e: 47             LD    B,A
...
472e: E5             PUSH  HL
472f: 21 03 C0       LD    HL,SOLAR_SAILER_Y
4732: 86             ADD   A,(HL)
4733: B8             CP    A,B
...
62f6: 21 03 C0       LD    HL,SOLAR_SAILER_Y
...
995d: 36 18          LD    (HL),#$18
995f: 21 03 C0       LD    HL,SOLAR_SAILER_Y
...
99d4: 16 00          LD    D,#$00
99d6: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
99d9: 5F             LD    E,A
99da: 19             ADD   HL,DE
99db: 19             ADD   HL,DE
...
99f4: 16 00          LD    D,#$00
99f6: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
99f9: 5F             LD    E,A
99fa: 19             ADD   HL,DE
99fb: 19             ADD   HL,DE
99fc: E5             PUSH  HL
...
9a05: E9             JP    (HL)
9a06: 2E 9A 0E 9A 1E 9A 08 06 44 18 44 
...
9b37: 3E 18          LD    A,#$18
9b39: AF             XOR   A,A
9b3a: 32 03 C0       LD    (SOLAR_SAILER_Y),A
...
9b79: 16 00          LD    D,#$00
9b7b: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
9b7e: D6 02          SUB   A,#$02
9b80: 5F             LD    E,A
9b81: 19             ADD   HL,DE
9b82: 19             ADD   HL,DE
...
9ba9: 3E 02          LD    A,#$02
9bab: 32 03 C0       LD    (SOLAR_SAILER_Y),A
9bae: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
...
9bc7: 21 03 C0       LD    HL,SOLAR_SAILER_Y
9bca: 34             INC   (HL)
9bcb: 18 E1          JR    $9BAE

9bcd: AF             XOR   A,A
9bce: 32 03 C0       LD    (SOLAR_SAILER_Y),A
9bd1: C9             RET   
...
9e9e: 3E 18          LD    A,#$18
9ea0: AF             XOR   A,A
9ea1: 32 03 C0       LD    (SOLAR_SAILER_Y),A
...
a375: AF             XOR   A,A
a376: 32 03 C0       LD    (SOLAR_SAILER_Y),A
...
a38b: 3A 03 C0       LD    A,(SOLAR_SAILER_Y)
a38e: FE 06          CP    A,#$06
...
a3a7: 21 03 C0       LD    HL,SOLAR_SAILER_Y
a3aa: 34             INC   (HL)
a3ab: 18 DE          JR    $A38B
