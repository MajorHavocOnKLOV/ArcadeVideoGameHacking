...
TANK_PROCESS_DISKS_THROWN EQU $45ff
...
TANK_CHECK_FOR_BULLET_AT_IY_HIT_ON_ALL_ENEMY_TANKS EQU $46f5
TANK_CHECK_BULLET_POSITION_IN_BC_FOR_HIT_ON_USER EQU $472b
...
45c5: C5             PUSH  BC
45c6: CD FF 45       CALL  TANK_PROCESS_DISKS_THROWN
...
4619: 8E             ADC   A,(HL)
461a: 4F             LD    C,A
461b: CD F5 46       CALL  TANK_CHECK_FOR_BULLET_AT_IY_HIT_ON_ALL_ENEMY_TANKS
461e: 30 05          JR    NC,$4625

4620: FD 36 0A 01    LD    (IY+$0A),#$01
4624: C9             RET   

4625: CD 2B 47       CALL  TANK_CHECK_BULLET_POSITION_IN_BC_FOR_HIT_ON_USER
...
*** Add deltas to X & Y (word based with carry)
TANK_CHECK_FOR_BULLET_AT_IY_HIT_ON_ALL_ENEMY_TANKS:
...
TANK_CHECK_BULLET_POSITION_IN_BC_FOR_HIT_ON_USER:
...
4a03: 23             INC   HL
4a04: 3A 02 C0       LD    A,(TANK_Y_OR_GS_DISK_Y_OR_SOLAR_SAILER_X_Y)
4a07: 47             LD    B,A
...
4bc8: 4F             LD    C,A
4bc9: E5             PUSH  HL
4bca: CD F5 46       CALL  TANK_CHECK_FOR_BULLET_AT_IY_HIT_ON_ALL_ENEMY_TANKS
...
4bdc: CD 2B 47       CALL  TANK_CHECK_BULLET_POSITION_IN_BC_FOR_HIT_ON_USER
