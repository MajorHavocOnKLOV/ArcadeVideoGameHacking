...
TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS EQU $c001
TANK_Y_OR_GS_DISK_Y EQU $c002
TANK_ENEMY_DESTROYED? EQU $c004
...
SPRITE_MCP_BLOCKS_TOP_LEFT_MOVING_DOWN_AND_WRAP_TO_TOP_RIGHT_TO_F09F EQU $f028
SPRITE_TANK_ENEMIES EQU $f02c
...
0fd4: 3E 02          LD    A,#$02
0fd6: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
0fd9: FD 21 DE FC    LD    IY,$FCDE
0fdd: 21 50 01       LD    HL,$0150
0fe0: 22 01 C0       LD    (TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS),HL
...
0ff0: 2A 01 C0       LD    HL,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
0ff3: 2B             DEC   HL
0ff4: 7C             LD    A,H
0ff5: B5             OR    A,L
...
125b: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED?
...
2118: 11 04 C0       LD    DE,TANK_ENEMY_DESTROYED?
...
2135: 4F             LD    C,A
2136: 87             ADD   A,A
2137: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED?
...
2d33: 21 01 C0       LD    HL,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
2d36: 36 03          LD    (HL),#$03
2d38: 0E 1C          LD    C,#$1C
2d3a: B7             OR    A,A
...
2d71: 57             LD    D,A
2d72: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
2d75: 47             LD    B,A
2d76: AF             XOR   A,A
2d77: 82             ADD   A,D
...
2d93: 06 1E          LD    B,#$1E
2d95: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
2d98: 0E 05          LD    C,#$05
...
2e7e: E6 10          AND   A,#$10
2e80: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED?
2e83: BE             CP    A,(HL)
2e84: C8             RET   Z
...
3381: FD 21 28 F0    LD    IY,SPRITE_MCP_BLOCKS_TOP_LEFT_MOVING_DOWN_AND_WRAP_TO_TOP_RIGHT_TO_F09F
3385: 21 59 35       LD    HL,MCP_BLOCKS_DATA_TO_35B2
3388: AF             XOR   A,A
3389: 32 01 C0       LD    (TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS),A
...
33ee: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
33f1: 3C             INC   A
33f2: FE 05          CP    A,#$05
...
3542: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
...
3a37: FD 21 01 C0    LD    IY,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
...
3ab9: D5             PUSH  DE
3aba: FD E1          POP   IY
3abc: 21 2C F0       LD    HL,SPRITE_TANK_ENEMIES
...
3e3f: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
3e42: CB 2F          SRA   A
3e44: 80             ADD   A,B
3e45: 47             LD    B,A
...
3e4c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
3e4f: CB 2F          SRA   A
3e51: 80             ADD   A,B
3e52: 47             LD    B,A
...
3e72: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
3e75: CB 2F          SRA   A
3e77: 57             LD    D,A
3e78: 78             LD    A,B
3e79: 92             SUB   A,D
...
3e80: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
3e83: CB 2F          SRA   A
3e85: 57             LD    D,A
3e86: 78             LD    A,B
3e87: 92             SUB   A,D
...
3ecc: 32 01 C0       LD    (TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS),A
...
3f65: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED?
3f68: 90             SUB   A,B
...
40d9: 77             LD    (HL),A
40da: 23             INC   HL
40db: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
40de: 77             LD    (HL),A
40df: 23             INC   HL
...
4570: 47             LD    B,A
4571: FD 21 01 C0    LD    IY,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
...
4736: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED?
4739: 86             ADD   A,(HL)
473a: B8             CP    A,B
...
483f: DD 21 01 C0    LD    IX,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
...
4a21: DD 21 01 C0    LD    IX,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
...
5d7c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
5d7f: E6 06          AND   A,#$06
...
5e0c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
5e0f: B7             OR    A,A
...
5f62: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
5f65: FE 01          CP    A,#$01
...
62c3: 21 01 C0       LD    HL,TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS
62c6: 96             SUB   A,(HL)
...
62d3: FD 21 28 F0    LD    IY,SPRITE_MCP_BLOCKS_TOP_LEFT_MOVING_DOWN_AND_WRAP_TO_TOP_RIGHT_TO_F09F
62d7: FD 36 00 00    LD    (IY+$00),#$00
62db: FD 36 02 00    LD    (IY+$02),#$00
62df: FD 36 01 3F    LD    (IY+$01),#$3F
62e3: AF             XOR   A,A
62e4: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
...
62f2: FD 21 2C F0    LD    IY,SPRITE_TANK_ENEMIES
62f6: 21 03 C0       LD    HL,$C003
62f9: 3A 02 C0       LD    A,(TANK_Y_OR_GS_DISK_Y)
62fc: FD 77 00       LD    (IY+$00),A
62ff: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
6302: 47             LD    B,A
6303: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
6306: 4F             LD    C,A
6307: FE 80          CP    A,#$80
...
633d: 32 28 F0       LD    (SPRITE_MCP_BLOCKS_TOP_LEFT_MOVING_DOWN_AND_WRAP_TO_TOP_RIGHT_TO_F09F),A
6340: 3A 01 C0       LD    A,(TANK_SPRITE_OR_MCP_ROWS_OF_BLOCKS)
6343: CD 59 71       CALL  ADJUST_SPRITE_Y_IF_FLIPPED_SCREEN
6346: 32 2A F0       LD    ($F02A),A
6349: 3E 0C          LD    A,#$0C
634b: 32 29 F0       LD    ($F029),A
634e: 3E 04          LD    A,#$04
6350: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
6353: C9             RET   
...
6357: 3E 01          LD    A,#$01
6359: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
635c: FD 21 2C F0    LD    IY,SPRITE_TANK_ENEMIES
...
6791: 3E 02          LD    A,#$02
6793: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
...
68e2: BD 37 BD F0 35 37 35 F0 35 D0 35 20 D0 D0 D0 20 
...
690f: 03 C8 40 70 01 11 C8 70 01 11 80 24 01 11 07 14 
691f: 06 64 C8 70 01 11 40 70 01 11 E8 48 02 11 28 48 
692f: 02 11 60 24 02 11 A0 24 02 11 06 1C 09 3C C8 70 
693f: 01 11 40 70 01 11 E8 48 02 11 28 48 02 11 60 98 
694f: 02 11 A0 98 02 11 84 98 04 11 60 24 01 11 A0 24 
695f: 01 11 05 1E 0D 1E 40 70 01 0E C8 70 01 0E 40 48 
696f: 02 0E C8 48 02 0E 60 98 02 0E A0 98 02 0E 80 98 
697f: 02 0E 40 C8 04 0E 50 B0 04 0E C0 C8 04 0E B0 B0 
698f: 05 0E 60 24 05 0E A0 24 01 0E 86 1E 19 14 48 24 
699f: 01 0E 58 24 01 0E 68 24 01 0E 78 24 01 0E 88 24 
69af: 01 0E 98 24 01 0E A8 24 01 0E B8 24 01 0E C8 24 
69bf: 01 0E C8 40 01 0E C8 58 01 0E C8 70 01 0E C8 88 
69cf: 01 0E B0 98 01 0E 98 A8 01 0E 84 B4 01 0E 74 C0 
69df: 01 0E 64 CC 01 0E 54 EC 01 0E 30 EC 01 0E 48 EC 
69ef: 01 0E 60 EC 01 0E 78 EC 01 0E 90 EC 01 0E B8 EC 
69ff: 01 0E 05 1E 0C 0A 40 70 01 0E C8 70 01 0E B0 88 
6a0f: 01 0E 58 88 01 0E 98 A0 01 0E 70 A0 01 0E 80 B8 
6a1f: 01 0E 88 B8 01 0E A0 D0 01 0E 68 D0 01 0E 50 E8 
6a2f: 01 0E B8 E8 01 0E 06 28 0D FF 80 98 01 11 C8 24 
6a3f: 01 11 40 24 01 11 40 40 01 11 C8 40 01 11 C8 60 
6a4f: 01 11 40 60 01 11 40 80 01 11 C8 80 01 11 C8 A0 
6a5f: 01 11 40 A0 01 11 40 C0 01 11 C8 C0 01 11 86 28 
6a6f: 16 FF 40 98 01 11 50 98 01 11 60 98 01 11 70 98 
6a7f: 01 11 80 98 01 11 90 98 01 11 A0 98 01 11 B0 98 
6a8f: 01 11 C0 98 01 11 D0 98 01 11 E0 98 01 11 48 B0 
6a9f: 01 11 58 B0 01 11 68 B0 01 11 78 B0 01 11 88 B0 
6aaf: 01 11 98 B0 01 11 A8 B0 01 11 B8 B0 01 11 C8 B0 
6abf: 01 11 D8 B0 01 11 E8 B0 01 11 86 28 1B FF 48 24 
6acf: 14 0E 68 24 14 0E 88 24 14 0E 48 40 14 0E B9 40 
6adf: 14 0E C9 50 14 0E 38 50 14 0E 28 60 14 0E D9 60 
6aef: 14 0E C9 70 14 0E 38 70 14 0E 28 80 14 0E B9 80 
6aff: 14 0E A0 98 14 0E 60 98 14 0E 80 A8 14 0E 70 B8 
6b0f: 14 0E 90 B8 14 0E 60 C8 14 0E A0 C8 14 0E B0 D8 
6b1f: 14 0E 50 D8 14 0E 60 EC 14 0E A0 EC 14 0E 90 EC 
6b2f: 14 0E 70 EC 14 0E 80 EC 14 0E 
...
991c: 2F             CPL   
991d: E6 10          AND   A,#$10
991f: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
...
998c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED?)
998f: 47             LD    B,A
9990: DB 00          IN    A,(IO_0)
9992: 2F             CPL   
9993: E6 10          AND   A,#$10
9995: 32 04 C0       LD    (TANK_ENEMY_DESTROYED?),A
9998: B7             OR    A,A
