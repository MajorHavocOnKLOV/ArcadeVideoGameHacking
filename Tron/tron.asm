org 0, numlab 850, numio 12, numdata 1588, numcomm 407, numcommline 531
...
ERASE_WITHOUT_LEADING_SPACE_S EQU $10ee
END_WITH_LEADING_SPACE_S EQU $10f5
END_WITHOUT_LEADING_SPACE_S EQU $10f6
...
LC_COUNTER_IF_WE_ARE_NOT_ZERO_RETURN_FROM_FOUR_CALLS? EQU $c150
...
ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED EQU $c414
...
0fce: 32 14 C4       LD    (ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED),A
...
104a: CB 39          SRL   C              ;Player 2 so shift joystick input bits
104c: CB 39          SRL   C
104e: CB 39          SRL   C
1050: CB 39          SRL   C
1052: 79             LD    A,C
...
1056: 21 14 C4       LD    HL,ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED
1059: E6 04          AND   A,#$04
...
106f: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
1072: 6F             LD    L,A
1073: 26 00          LD    H,#$00
1075: 29             ADD   HL,HL
1076: 19             ADD   HL,DE
...
109b: 09             ADD   HL,BC
109c: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
109f: C6 41          ADD   A,#$41
10a1: 77             LD    (HL),A
10a2: 23             INC   HL
10a3: 36 50          LD    (HL),#$50
10a5: 3A 14 C4       LD    A,(ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED)
10a8: 32 03 C0       LD    (SOLAR_SAILER_Y_SERVICE_MENU_ROW),A
10ab: CB 27          SLA   A
10ad: CB 27          SLA   A
10af: CB 27          SLA   A
10b1: C6 10          ADD   A,#$10
...
10bc: 3A 14 C4       LD    A,(ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED)
10bf: 6F             LD    L,A
10c0: 26 00          LD    H,#$00
10c2: 29             ADD   HL,HL
10c3: 19             ADD   HL,DE
...
10ca: 11 EE 10       LD    DE,ERASE_WITHOUT_LEADING_SPACE_S
10cd: C3 FF 6F       JP    ADD_A_MESSAGE_TO_Q

10d0: FE 1B          CP    A,#$1B
10d2: 20 06          JR    NZ,MOVE_SELECTED_LETTER_LEFT

10d4: 11 F6 10       LD    DE,END_WITHOUT_LEADING_SPACE_S
10d7: C3 FF 6F       JP    ADD_A_MESSAGE_TO_Q

MOVE_SELECTED_LETTER_LEFT:
10da: 3A 14 C4       LD    A,(ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED)
10dd: C6 41          ADD   A,#$41
10df: 77             LD    (HL),A
10e0: 23             INC   HL
10e1: 36 50          LD    (HL),#$50
...
125e: 3A 14 C4       LD    A,(ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED)
1261: FE 1A          CP    A,#$1A
...
1283: 3A 14 C4       LD    A,(ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED)
1286: C6 41          ADD   A,#$41
...
1296: 3E 1B          LD    A,#$1B
1298: 32 14 C4       LD    (ENTER_INITIALS_HIGH_SCORE_ROW_SELECTED),A
...
2e88: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
2e8b: 7E             LD    A,(HL)
2e8c: B7             OR    A,A
...
2e94: 3E 04          LD    A,#$04
2e96: 32 03 C0       LD    (SOLAR_SAILER_Y_SERVICE_MENU_ROW),A
...
3bcf: 3E 35          LD    A,#$35
3bd1: 32 50 C1       LD    (LC_COUNTER_IF_WE_ARE_NOT_ZERO_RETURN_FROM_FOUR_CALLS?),A
...
3e22: 32 50 C1       LD    (LC_COUNTER_IF_WE_ARE_NOT_ZERO_RETURN_FROM_FOUR_CALLS?),A
3e25: 3A 00 C0       LD    A,(CPU_RAM_GS_DISK_X_TANK_X_MCP_TRON_LEGS_LC_TRAILS_TO_C1DF_OR_SCORE_RANKING)
3e28: 47             LD    B,A
3e29: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
3e2c: 80             ADD   A,B
3e2d: 81             ADD   A,C
3e2e: 47             LD    B,A
...
3e9c: 78             LD    A,B
3e9d: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
3ea0: 96             SUB   A,(HL)
...
3f21: 21 50 C1       LD    HL,LC_COUNTER_IF_WE_ARE_NOT_ZERO_RETURN_FROM_FOUR_CALLS?
...
3f34: 3A 50 C1       LD    A,(LC_COUNTER_IF_WE_ARE_NOT_ZERO_RETURN_FROM_FOUR_CALLS?)
...
3f5a: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
3f5d: 86             ADD   A,(HL)
3f5e: 47             LD    B,A
...
472e: E5             PUSH  HL
472f: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
4732: 86             ADD   A,(HL)
4733: B8             CP    A,B
...
62f6: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
...
995d: 36 18          LD    (HL),#$18
995f: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
...
99d4: 16 00          LD    D,#$00
99d6: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
99d9: 5F             LD    E,A
99da: 19             ADD   HL,DE
99db: 19             ADD   HL,DE
...
99f4: 16 00          LD    D,#$00
99f6: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
99f9: 5F             LD    E,A
99fa: 19             ADD   HL,DE
99fb: 19             ADD   HL,DE
99fc: E5             PUSH  HL
...
9b79: 16 00          LD    D,#$00
9b7b: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
9b7e: D6 02          SUB   A,#$02
9b80: 5F             LD    E,A
9b81: 19             ADD   HL,DE
9b82: 19             ADD   HL,DE
...
9ba9: 3E 02          LD    A,#$02
9bab: 32 03 C0       LD    (SOLAR_SAILER_Y_SERVICE_MENU_ROW),A
9bae: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
...
9bc7: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
9bca: 34             INC   (HL)
9bcb: 18 E1          JR    $9BAE

9bcd: AF             XOR   A,A
9bce: 32 03 C0       LD    (SOLAR_SAILER_Y_SERVICE_MENU_ROW),A
9bd1: C9             RET   
...
a375: AF             XOR   A,A
a376: 32 03 C0       LD    (SOLAR_SAILER_Y_SERVICE_MENU_ROW),A
...
a38b: 3A 03 C0       LD    A,(SOLAR_SAILER_Y_SERVICE_MENU_ROW)
a38e: FE 06          CP    A,#$06
...
a3a7: 21 03 C0       LD    HL,SOLAR_SAILER_Y_SERVICE_MENU_ROW
a3aa: 34             INC   (HL)
a3ab: 18 DE          JR    $A38B
