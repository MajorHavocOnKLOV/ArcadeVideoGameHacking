org 0, numlab 788, numio 12, numdata 1574, numcomm 284, numcommline 470
...
IO_TOWER_TIMER_TO_OUTPUT_DO_IT_BOOLEAN EQU $c451
IO_TOWER_TIMER_TO_OUTPUT_DESTINATION EQU $c452
IO_TOWER_TIMER_TO_OUTPUT_SOURCE EQU $c454
...
0792: 21 51 C4       LD    HL,IO_TOWER_TIMER_TO_OUTPUT_DO_IT_BOOLEAN
0795: 7E             LD    A,(HL)
0796: B7             OR    A,A
0797: C8             RET   Z

0798: 36 00          LD    (HL),#$00
079a: 2A 52 C4       LD    HL,(IO_TOWER_TIMER_TO_OUTPUT_DESTINATION)
079d: ED 4B 54 C4    LD    BC,(IO_TOWER_TIMER_TO_OUTPUT_SOURCE)
...
0aa0: 21 19 C4       LD    HL,HARDNESS_AND_USER_LEVEL_OR_CURRENT_PLAYER_DATA
...
0acc: 7E             LD    A,(HL)
0acd: EE 01          XOR   A,#$01
0acf: 77             LD    (HL),A         ;Toggle the flip screen bit?  If so, this code section switches between players 1 & 2
...
5f0c: 22 52 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_DESTINATION),HL
5f0f: 21 F2 68       LD    HL,$68F2
5f12: 22 54 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_SOURCE),HL
5f15: 32 51 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_DO_IT_BOOLEAN),A
...
5f26: 22 54 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_SOURCE),HL
...
5f3e: 22 52 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_DESTINATION),HL
5f41: 3E 01          LD    A,#$01
5f43: 32 51 C4       LD    (IO_TOWER_TIMER_TO_OUTPUT_DO_IT_BOOLEAN),A
5f46: C9             RET   
...
ZERO_RAM_C000-C450:
7026: 21 51 C4       LD    HL,IO_TOWER_TIMER_TO_OUTPUT_DO_IT_BOOLEAN
ZERO_RAM_C000-C479:
7029: 2D             DEC   L
702a: 36 00          LD    (HL),#$00
