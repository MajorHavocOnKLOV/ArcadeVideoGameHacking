org 0, numlab 814, numio 12, numdata 1573, numcomm 296, numcommline 479
...
DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES? EQU $a079
...
IO_TOWER_NUMBER_OF_GRID_BUGS EQU $c01d
...
0154: 3E 40          LD    A,#$40
0156: 32 79 C4       LD    (what_is_this?),A
...
03e5: 21 79 C4       LD    HL,what_is_this?
03e8: B7             OR    A,A
...
0a66: 2A FD C4       LD    HL,(BONUS_PLAYER_AT_XX000_DIGITS)
...
0a81: 2A 84 C6       LD    HL,(GAMES_PLAYED_COUNT)
0a84: 23             INC   HL
0a85: 22 84 C6       LD    (GAMES_PLAYED_COUNT),HL
...
0cf0: 12             LD    (DE),A
0cf1: 1B             DEC   DE
0cf2: 3A FD C4       LD    A,(BONUS_PLAYER_AT_XX000_DIGITS)
0cf5: C6 30          ADD   A,#$30
0cf7: 12             LD    (DE),A
...
0e73: 2A FD C4       LD    HL,(BONUS_PLAYER_AT_XX000_DIGITS)
...
129e: 21 6C C6       LD    HL,TIME_REPORT_DATA_?
...
12d2: DD 21 6C C6    LD    IX,TIME_REPORT_DATA_?
...
*** If this game is longest played, save time to display in bookkeeping
...
1310: 21 2A C5       LD    HL,LONGEST_GAME_MINUTES_2
...
1323: 32 2A C5       LD    (LONGEST_GAME_MINUTES_2),A
1326: 3A 1B C4       LD    A,(PLAYING_HOW_LONG_NOW_SECONDS)
1329: 32 2B C5       LD    (LONGEST_GAME_SECONDS_2),A
132c: C9             RET   
...
137f: DD 21 6C C6    LD    IX,TIME_REPORT_DATA_?
...
5df5: 77             LD    (HL),A
5df6: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
5df9: 7E             LD    A,(HL)
5dfa: FE 28          CP    A,#$28
...
5e1f: EE 80          XOR   A,#$80
5e21: 77             LD    (HL),A
5e22: 3A 1D C0       LD    A,(IO_TOWER_NUMBER_OF_GRID_BUGS)
...
6504: 3A 1D C0       LD    A,(IO_TOWER_NUMBER_OF_GRID_BUGS)
...
6647: 6F             LD    L,A
6648: 0E 04          LD    C,#$04
664a: 3A 1D C0       LD    A,(IO_TOWER_NUMBER_OF_GRID_BUGS)
664d: 47             LD    B,A
...
67c7: 23             INC   HL
67c8: 46             LD    B,(HL)
67c9: 32 1D C0       LD    (IO_TOWER_NUMBER_OF_GRID_BUGS),A
67cc: 90             SUB   A,B
...
9fc0: 80             ADD   A,B
9fc1: C6 DD          ADD   A,#$DD
9fc3: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
9fc6: CD 69 A0       CALL  CONVERT_HL_TO_6_DIGIT_BCD_AT_IX
9fc9: 06 05          LD    B,#$05
9fcb: 0E 00          LD    C,#$00
9fcd: 1E 01          LD    E,#$01
9fcf: DD 21 06 FA    LD    IX,$FA06
9fd3: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
9fd6: CD 79 A0       CALL  DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
9fd9: 2A 82 C6       LD    HL,(RIGHT_2_COIN_COUNT)
9fdc: DD 21 1D C0    LD    IX,IO_TOWER_NUMBER_OF_GRID_BUGS
9fe0: CD 69 A0       CALL  CONVERT_HL_TO_6_DIGIT_BCD_AT_IX
9fe3: 06 05          LD    B,#$05
9fe5: 0E 00          LD    C,#$00
9fe7: 1E 01          LD    E,#$01
9fe9: DD 21 0A FA    LD    IX,$FA0A
9fed: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
9ff0: CD 79 A0       CALL  DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
9ff3: 21 28 C5       LD    HL,LONGEST_GAME_MINUTES
9ff6: DD 21 0E FA    LD    IX,$FA0E
9ffa: CD B7 A0       CALL  $A0B7
9ffd: 21 2A C5       LD    HL,LONGEST_GAME_MINUTES_2
...
a023: 2A 84 C6       LD    HL,(GAMES_PLAYED_COUNT)
a026: DD 21 1D C0    LD    IX,IO_TOWER_NUMBER_OF_GRID_BUGS
a02a: CD 69 A0       CALL  CONVERT_HL_TO_6_DIGIT_BCD_AT_IX
a02d: 06 05          LD    B,#$05
a02f: 0E 00          LD    C,#$00
a031: 1E 01          LD    E,#$01
a033: DD 21 1E FA    LD    IX,$FA1E
a037: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
a03a: C3 79 A0       JP    DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
...
*** If E == 0, 6 digits.  Otherwise 3 digits?
DISPLAY_6_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES:
a077: 1E 00          LD    E,#$00
DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?:
a079: 7B             LD    A,E
a07a: B7             OR    A,A
a07b: 7E             LD    A,(HL)
...
a0b3: D1             POP   DE
a0b4: 10 C3          DJNZ  DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
...
a0e9: FD E5          PUSH  IY
a0eb: EB             EX    DE,HL
a0ec: DD 21 1D C0    LD    IX,IO_TOWER_NUMBER_OF_GRID_BUGS
a0f0: CD 69 A0       CALL  CONVERT_HL_TO_6_DIGIT_BCD_AT_IX
a0f3: 06 05          LD    B,#$05
a0f5: 0E 00          LD    C,#$00
a0f7: 1E 01          LD    E,#$01
a0f9: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
a0fc: FD E1          POP   IY
...
a107: FD 23          INC   IY
a109: FD 23          INC   IY
a10b: CD 79 A0       CALL  DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
a10e: C1             POP   BC
a10f: E1             POP   HL
...
a224: FD E5          PUSH  IY
a226: EB             EX    DE,HL
a227: DD 21 1D C0    LD    IX,IO_TOWER_NUMBER_OF_GRID_BUGS
a22b: CD 69 A0       CALL  CONVERT_HL_TO_6_DIGIT_BCD_AT_IX
a22e: 06 06          LD    B,#$06
a230: 0E 00          LD    C,#$00
a232: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
a235: FD E1          POP   IY
...
a521: FD E5          PUSH  IY
a523: DD E5          PUSH  IX
a525: DD 21 1D C0    LD    IX,IO_TOWER_NUMBER_OF_GRID_BUGS
...
a541: 1E 01          LD    E,#$01
a543: CD 79 A0       CALL  DISPLAY_3_DIGIT_BCD_FROM_HL_TO_IX_LEADING_ZEROES_GOTO_SPACES?
a546: DD E1          POP   IX
...
a841: 21 1D C0       LD    HL,IO_TOWER_NUMBER_OF_GRID_BUGS
...
a862: 36 00          LD    (HL),#$00
a864: 11 1D C0       LD    DE,IO_TOWER_NUMBER_OF_GRID_BUGS
