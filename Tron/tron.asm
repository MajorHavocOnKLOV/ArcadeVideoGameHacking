org 0, numlab 773, numio 12, numdata 1574, numcomm 278, numcommline 468
...
TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X EQU $c004
...
0fd4: 3E 02          LD    A,#$02
0fd6: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
...
125b: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
...
2118: 11 04 C0       LD    DE,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
...
2135: 4F             LD    C,A
2136: 87             ADD   A,A
2137: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
...
2e7e: E6 10          AND   A,#$10
2e80: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
2e83: BE             CP    A,(HL)
2e84: C8             RET   Z
...
3e3f: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
3e42: CB 2F          SRA   A
3e44: 80             ADD   A,B
3e45: 47             LD    B,A
...
3e4c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
3e4f: CB 2F          SRA   A
3e51: 80             ADD   A,B
3e52: 47             LD    B,A
...
3e72: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
3e75: CB 2F          SRA   A
3e77: 57             LD    D,A
3e78: 78             LD    A,B
3e79: 92             SUB   A,D
...
3e80: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
3e83: CB 2F          SRA   A
3e85: 57             LD    D,A
3e86: 78             LD    A,B
3e87: 92             SUB   A,D
...
3f65: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
3f68: 90             SUB   A,B
...
4736: 21 04 C0       LD    HL,TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X
4739: 86             ADD   A,(HL)
473a: B8             CP    A,B
...
5d7c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
5d7f: E6 06          AND   A,#$06
...
5e0c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
5e0f: B7             OR    A,A
...
5f62: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
5f65: FE 01          CP    A,#$01
...
62e3: AF             XOR   A,A
62e4: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
...
62ff: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
...
634e: 3E 04          LD    A,#$04
6350: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A;Set flag to continue moving Solar Sailer but stop checking to drop Bit
6353: C9             RET   
...
6357: 3E 01          LD    A,#$01
6359: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
...
6791: 3E 02          LD    A,#$02
6793: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
...
991c: 2F             CPL   
991d: E6 10          AND   A,#$10
991f: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
...
998c: 3A 04 C0       LD    A,(TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X)
998f: 47             LD    B,A
9990: DB 00          IN    A,(IO_0)
9992: 2F             CPL   
9993: E6 10          AND   A,#$10
9995: 32 04 C0       LD    (TANK_ENEMY_DESTROYED_OR_SOLAR_SAILER_STATUS_FLAG_TANK_HITBOX_X),A
9998: B7             OR    A,A
